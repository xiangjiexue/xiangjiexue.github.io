...
[here](https://github.com/xiangjiexue/npfixedcompR) for the source code. There is also [a developing version](https://github.com/xiangjiexue/npfixedcomp2) of the package using C++ and Eigen library.
...
The slides for oral examination can be found [here](./files/def.html).
