...
gg_point = ggplot(df, aes(x = "", y = filesize, fill = filework)) +
  geom_bar_interactive(width = 1, stat = "identity", tooltip = paste(filename, "has size", filesize, "kB"), data_id = filesize) +
...
This is a good example on how computer programs change our life: only small amount of code is written by me and the rest is taken care of by various software packages.
