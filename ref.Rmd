...
The following table only shows the first two authors.
```{r echo = FALSE}
...
df = select(df, "id", "issued.date.parts", "title", "type", "author.family",
            "author.given", "author.family.1", "author.given.1")
colnames(df) = c("id", "year", "title", "type", "author1.family", "author1.given",
                 "author2.family", "author2.given")
datatable(df)
```
